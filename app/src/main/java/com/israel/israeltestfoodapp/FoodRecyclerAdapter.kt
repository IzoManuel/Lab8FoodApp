...
class FoodRecyclerAdapter (var context: Context) : RecyclerView.Adapter<FoodRecyclerAdapter.ViewHolder>()  {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, i: Int) {
        ...
        viewHolder.itemView.setOnClickListener {
            ...
            val intent = Intent(context, SingleItemActivity::class.java).apply {
                putExtra("image", images[i])
                putExtra("title", titles[i])
                putExtra("detail", details[i])
            }
